  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center min-h-[50vh]">
        <Loader size="md" text="Loading leads..." />
      </div>
    );
  }
      ...
      >
        {!chatUser ? (
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="rounded-2xl border border-gray-200 bg-gradient-to-b from-gray-50 via-white to-gray-50 p-3 sm:p-4">
              <div className="h-[46vh] overflow-y-auto pr-1 sm:h-[55vh] sm:pr-2">
                {chatLoading ? (
                    ...
                    {Array.isArray(chatMessages) ? [...chatMessages]
                      ...
                      .map((msg) => {
                        ...
                        return (
                          ...
                          >
                            <div
                              className={`max-w-[88%] rounded-2xl px-3 py-2 shadow-sm sm:max-w-[75%] sm:px-4 ${
                                isOutgoing
            ...
            <div className="border border-gray-200 rounded-2xl p-3 bg-white shadow-sm">
              ...
              <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
                <input
                  ...
                  className="min-w-0 w-full flex-1 px-4 py-2 rounded-full border border-gray-200 focus:outline-none focus:ring-2 focus:ring-aa-orange"
                  disabled={chatSending}
                />
                <button
                  onClick={sendChatMessage}
                  disabled={chatSending || !chatDraft.trim()}
                  className="w-full rounded-full bg-aa-orange px-4 py-2 font-semibold text-white disabled:cursor-not-allowed disabled:opacity-60 sm:w-auto sm:shrink-0"
                >
